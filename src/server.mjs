...
new SocketClient('ftmusdt', 1, 3600000); 
new SocketClient('funusdt', 2, 3605000); 
new SocketClient('fxsusdt', 3, 3610000); 
new SocketClient('galausdt', 4, 3615000); 
new SocketClient('galusdt', 5, 3620000); 
new SocketClient('gbpusdt', 6, 3625000); 
new SocketClient('ghstusdt', 7, 3630000); 
new SocketClient('glmrusdt', 8, 3635000); 
new SocketClient('gmtusdt', 9, 3640000); 
new SocketClient('gmxusdt', 10, 3645000); 
new SocketClient('gnousdt', 11, 3650000); 
new SocketClient('grtusdt', 12, 3655000); 
new SocketClient('gtcusdt', 13, 3660000); 
new SocketClient('hardusdt', 14, 3665000); 
new SocketClient('hbarusdt', 15, 3670000);
new SocketClient('hftusdt', 16, 3675000); 
new SocketClient('highusdt', 17, 3680000); 
new SocketClient('hiveusdt', 18, 3685000); 
new SocketClient('hookusdt', 19, 3690000); 
new SocketClient('hotusdt', 20, 3695000); 
new SocketClient('icpusdt', 21, 3700000); 
new SocketClient('icxusdt', 22, 3705000); 
new SocketClient('idexusdt', 23, 3710000); 
new SocketClient('ilvusdt', 24, 3715000); 
new SocketClient('imxusdt', 25, 3720000); 
new SocketClient('injusdt', 26, 3725000); 
new SocketClient('iostusdt', 27, 3730000);
new SocketClient('iotausdt', 28, 3735000); 
new SocketClient('iotxusdt', 29, 3740000); 
new SocketClient('irisusdt', 30, 3745000); 
new SocketClient('jasmyusdt', 31, 3750000); 
new SocketClient('joeusdt', 32, 3755000); 
new SocketClient('jstusdt', 33, 3760000); 
new SocketClient('juvusdt', 34, 3765000); 
new SocketClient('kavausdt', 35, 3770000); 
new SocketClient('kdausdt', 36, 3775000);
new SocketClient('keyusdt', 37, 3780000);
new SocketClient('klayusdt', 38, 3785000); 
new SocketClient('kmdusdt', 39, 3790000); 
new SocketClient('kncusdt', 40, 3795000); 
